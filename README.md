...
تمرین هفته هفتم : انواع دیتا تایپ ها در پایگاه داده 

تو پایگاه های داده انواع مختلفی از دیتا تایپ ها وجود داره که هر کدوم ویژگی ها و کاربردهای خاص خودشون رو دارن برای مثال :
نوع داده  Integer :  این نوع برای ذخیره اعداد صحیح بکار میره و اندازه اون  4 بایته و برای محدوده ی اعداد صحیح 31^2-یا (2,147,483,648-) تا 1-31^2یا (2,147,483,647) استفاده میشه.
نوع داده های : float  و Double  برای ذخیره اعداد اعشاری با دقت متغیر بکار میرن و ظرفیت Double  یشتر از Float  است.
نوع داده cahr : این نوع داده دارای طول ثابتیه و n بایت داده تو اون بصورت Non-Unicode نگهداری می شه. این n  میتونه از  1  تا  8000   باشه.
نوع داده  : Varchar  دارای طول متغیر بوده و کاراکترهای آن بصورت Non-Unicode هستند .این نوع داده هم بین  1  تا  8000  میتونه باشه.
داده های  Date  و Time  : برای ذخیره تاریخ و ساعت از این نوع دیتا تایپ ها استفاده میشه. فرمت رشته ای آن به صورت YYYY-MM-DD.
برای ذخیره مقادیر منطقی صحیح یا غلط یا همون True - False  از نوع داده  Boolean  استفاده میشه.
نوع داده Cursor: این نوع داده برای ذخیره ی متغیر ها یا پارامترهای OUTPUT مربوط به store proceduere کاربرد داره.
نوع داده  Real : این نوع داده محدوده اعداد اعشاری 3.40E+38- تا 3.40E + 38 رو شامل میشه و دقتش تا 38 رقمه.
نوع داده Money: برای ذخیره مقادیر پول کاربرد دارد.
نوع های Numeric و decimal: این نوع داده ها برای ذخیره داده هایی با اعداد اعشاری دارای ممیز شناور بدون گرد کردن استفاده میشن.
